...
public class BubbleSortFrame2 extends JFrame implements PropertyChangeListener,
	   ...
	   ButtonPanel.SortButtonListener, MyCanvas.VisualizerProvider
{
	...
	public static void main(String[] args)
	{
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new BubbleSortFrame2().setVisible(true);
			}
		});
	}
	...
	{	
		...
		setTitle("Bubble Sort Algorithm Visualizer");
	...
	public void sortButtonClicked(int id)
	{
		switch (id)
		{
			...
			case 1:  // bubble button
                ...
                break;
			case 2: // back button
				this.dispose(); // Đóng cửa sổ BubbleSortFrame22 hiện tại
	            mainMenu.setVisible(true); // Hiển thị cửa sổ MainMenu
	            break;
			case 3:
